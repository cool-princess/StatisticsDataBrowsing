            ...
            <div class="wrap">
                <div class="wrapper active">
                    ...
                    <div class="mainbar">
                                ...
                                <div class="mail-create-part">
                                    ...
                                    <div class="mail-content-body">
                                        ...
                                        <div class="mail-content-item">
                                            ...
                                            <div class="mail-content-item-right">
                                                <input type="text" placeholder="メールタイトル" name="title" value="{{ $mails[0]->title }}" required>
                                            </div>
                                        </div>
                                        <div class="mail-content-item">
                                            <div class="mail-content-item-left">
                                            ...
                                            <div class="mail-content-item-right">
                                                <textarea name="body" id="" value="{{ $mails[0]->body }}" placeholder="[com]&#10;&#10;[unit]&#10;&#10;[name]様&#10;&#10;登録されたID・パスワードは以下になります。&#10;&#10;ID=[id]&#10;&#10;PW=[pw]">{{ $mails[0]->body }}</textarea>
                                            </div>
                                        </div>
                                        <div class="mail-content-item">
                                            <div class="mail-content-item-left">
                        ...
                        <form method="get" action="{{ route('userMailSearchGet', ['id' => $mails[0]->id]) }}" id="searchForm">
